...
const { ApiCategoriesIdDeleteRoute } = require('../../../../../src/routes');
const {
	AsyncFunction,
	createCategoryObjectStub,
} = require('../../../../_helpers');

describe('ApiCategoriesIdDeleteRoute', () => {
	...
	beforeEach(() => {
		...
		subject = new ApiCategoriesIdDeleteRoute(categoriesDao);
	});
	...
	describe('getOptions()', () => {
		it('should return the primitive properties as an object', () => {
			...
			expect(actual.url).to.be.eql('/api/categories/:id');
