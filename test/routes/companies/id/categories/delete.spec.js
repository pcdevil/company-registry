...
const { CompaniesIdCategoriesDeleteRoute } = require('../../../../../src/routes');
const {
	AsyncFunction,
	createCompanyObjectStub,
} = require('../../../../_helpers');

describe('CompaniesIdCategoriesDeleteRoute', () => {
	...
	beforeEach(() => {
		...
		subject = new CompaniesIdCategoriesDeleteRoute(companiesDao);
	});
	...
	describe('getOptions()', () => {
		it('should return the primitive properties as an object', () => {
			...
			expect(actual.url).to.be.eql('/companies/:companyId/categories/:categoryId');
